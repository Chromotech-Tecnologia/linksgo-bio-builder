...
const Register = () => {
  ...
  const benefits = [
    "Página de bio links personalizada",
          ...
          <div className="hidden lg:block space-y-6">
            <div>
              ...
              <p className="text-lg text-muted-foreground">
                Junte-se a mais de 50.000 criadores que usam o LinksGo para conectar seu público.
              </p>
            </div>
            ...
            <div className="space-y-3">
              {benefits.map((benefit, index) => (
                <div key={index} className="flex items-center space-x-3">
                  <div className="flex items-center justify-center w-6 h-6 bg-gradient-primary rounded-full">
            ...
            <div className="bg-gradient-card p-6 rounded-2xl border border-white/20">
              <p className="text-muted-foreground italic">
                "O LinksGo transformou completamente como compartilho meu conteúdo. 
                Em 30 dias aumentei meus seguidores em 200%!"
              </p>
              <div className="flex items-center mt-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-xs">@mariasilva • 100K seguidores</p>
                </div>
              </div>
            </div>
          </div>
